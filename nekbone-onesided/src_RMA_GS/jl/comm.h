...
#ifdef HPE_ONE_SIDED
static void comm_get(MPI_Win *win, const struct comm *c,
                     void *p, size_t n, uint src, uint disp);
static void comm_put(MPI_Win *win, const struct comm *c,
                     void *p, size_t n, uint dst, uint disp);
#endif
...
{
#ifdef MPI
//  printf("FOOBAR: MPI_Get(p=%d,n=%d, src=%d, disp=%d, n=%d, win=%lxu\n",p,n,src,disp,n,win);
  MPI_Get(p,n,MPI_UNSIGNED_CHAR,src,disp,n,MPI_UNSIGNED_CHAR,*win);
#endif
}
...
{
#ifdef MPI
//  printf("FOOBAR: MPI_Put(p=%d,n=%d, dst=%d, disp=%d, n=%d, win=%lxu\n",p,n,dst,disp,n,win);
  MPI_Put(p,n,MPI_UNSIGNED_CHAR,dst,disp,n,MPI_UNSIGNED_CHAR,*win);
#endif
}
#endif
